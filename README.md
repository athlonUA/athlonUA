...
[**GpsLogger**](https://github.com/athlonUA/GpsLogger): end-to-end GPS tracking system with a SwiftUI iOS client and a typed backend. Design rule: collect raw location data with zero interpretation. No trip detection, no behavior inference, no opinions about the data.

[**ValenciaGo**](https://github.com/athlonUA/ValenciaGo): multilingual event discovery platform for Valencia. Aggregates from six public sources, normalizes, deduplicates, classifies, summarizes via AI in English, Ukrainian, and Spanish, delivers through a Telegram bot.
...
- GitHub: [@athlonUA](https://github.com/athlonUA)
